"""
scripts/generate_playground_notebook.py

Description:
    This script programmatically generates a Jupyter Notebook (`testing_and_results.ipynb`)
    in the workspace root. It configures the notebook cells to execute live evaluations,
    display retrieval scores and paper titles, and render Obsidian note metadata cleanly.
"""
...
def main():
    ...
    output_path = Path("testing_and_results.ipynb")
    with open(output_path, "w", encoding="utf-8") as f:
        json.dump(notebook, f, indent=2, ensure_ascii=False)
        
    print(f"[OK] programmatically generated {output_path}")
